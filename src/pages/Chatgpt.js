...
export default function Chatgpt() {
  ...
  const [hasJoinedMessageDisplayed, setHasJoinedMessageDisplayed] =
    useState(false);
  ...
  useEffect(() => {
    if (!hasJoinedMessageDisplayed) {
      setMessages([
        { role: "assistant", content: "ChatGPT joined the conversation." },
      ]);
      setHasJoinedMessageDisplayed(true);
    } else {
  ...
  }, [messages, hasJoinedMessageDisplayed]);
